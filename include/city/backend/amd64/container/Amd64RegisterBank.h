...
namespace city
{
    struct Amd64RegisterBank
    {
        std::array<Amd64Register, 16> r = {
                ...
                Amd64Register(4, Amd64RegisterValueType::Integer, Amd64RegisterType::Special, false),
                Amd64Register(5, Amd64RegisterValueType::Integer, Amd64RegisterType::Special, false),
